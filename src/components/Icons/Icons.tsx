...
export function EditIcon({ color = "#2E66E6", size = "24" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ErrorIcon({ color = "#c94515", size = "24" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SearchIcon({ color = "#5C667E", size = "24" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SortIcon({ color = "#5C667E", size = "20", className = "" }) {
  return (
    <svg
      width={size}
      height={size}
